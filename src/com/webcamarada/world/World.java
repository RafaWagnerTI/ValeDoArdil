		...
		try {
			...
			for(int xx = 0; xx < WIDTH; xx++) {
				for(int yy = 0; yy < HEIGHT; yy++) {
					...
					switch(pixelAtual){
						case 0xFF000000: tiles[xx + (yy*WIDTH)] = new FloorTile(xx*16, yy*16,Tile.TILE_FLOOR); break;//Ch�o
						...
						case 0xFFFFD800: Game.entities.add(new Bullet(xx*16, yy*16, 16, 16, Entity.BULLET_EN));break;//Muni��o
						...
						default: tiles[xx + (yy*WIDTH)] = new FloorTile(xx*16, yy*16,Tile.TILE_FLOOR);         break;//Ch�o
					}
